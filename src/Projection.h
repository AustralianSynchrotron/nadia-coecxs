 ...
 * Projection::initialise_estimate() method can be used to set up an
 ...
 * required. The Projection::set_custom_algorithm allows the
 ...
 * Projection::iterate() method.  This is automatically update the
 * values in the Complex_2D estimate and the current error. The error
 * can be retrieved using Projection::get_current_error(). The
